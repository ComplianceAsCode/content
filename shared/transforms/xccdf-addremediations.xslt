...
<!-- This transform expects stringparams "bash_remediations", "ansible_remediations", "puppet_remediations",
     "anaconda_remediations", "ignition_remediations", "kubernetes_remediations", "osbuild_blueprint_remediations"
...
<xsl:param name="osbuild_blueprint_remediations"/>
...
<xsl:variable name="osbuild_blueprint_remediations_doc" select="document($osbuild_blueprint_remediations)" />
<xsl:variable name="osbuild_blueprint_fixgroup" select="$osbuild_blueprint_remediations_doc/xccdf:fix-content/xccdf:fix-group" />
<xsl:variable name="osbuild_blueprint_fixcommongroup" select="$osbuild_blueprint_remediations_doc/xccdf:fix-content/xccdf:fix-common-group" />


<xsl:variable name="fixgroups" select="$bash_fixgroup | $ansible_fixgroup | $puppet_fixgroup | $anaconda_fixgroup | $ignition_fixgroup | $kubernetes_fixgroup|$osbuild_blueprint_fixgroup" />
<xsl:variable name="fixcommongroups" select="$bash_fixcommongroup | $ansible_fixcommongroup | $puppet_fixcommongroup | $anaconda_fixcommongroup | $ignition_fixcommongroup | $kubernetes_fixcommongroup|$osbuild_blueprint_fixcommongroup" />
