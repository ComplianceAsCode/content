...
<xsl:variable name="disa-appsrguri">https://www.cyber.mil/stigs/downloads/?_dl_facet_stigs=application-servers</xsl:variable>
<xsl:variable name="disa-cciuri">https://www.cyber.mil/stigs/cci/</xsl:variable>
<xsl:variable name="disa-ossrguri">https://www.cyber.mil/stigs/downloads/?_dl_facet_stigs=operating-systems%2Cgeneral-purpose-os</xsl:variable>
<xsl:variable name="disa-stigs-apps-appsecurity-dev-uri">https://www.cyber.mil/stigs/downloads/?_dl_facet_stigs=app-security%2Capp-security-dev</xsl:variable>
<xsl:variable name="disa-stigs-apps-appserver-uri">https://www.cyber.mil/stigs/downloads/?_dl_facet_stigs=app-security%2Capplication-servers</xsl:variable>
<xsl:variable name="disa-stigs-apps-browers-uri">https://www.cyber.mil/stigs/downloads/?_dl_facet_stigs=app-security%2Cbrowser-guidance</xsl:variable>
<xsl:variable name="disa-stigs-apps-web-server-uri">https://www.cyber.mil/stigs/downloads/?_dl_facet_stigs=app-security%2Cweb-servers</xsl:variable>
<xsl:variable name="disa-stigs-os-mainframe-uri">https://www.cyber.mil/stigs/downloads/?_dl_facet_stigs=operating-systems%2Cmainframe</xsl:variable>
<xsl:variable name="disa-stigs-os-unix-linux-uri">https://www.cyber.mil/stigs/downloads/?_dl_facet_stigs=operating-systems%2Cunix-linux</xsl:variable>
<xsl:variable name="disa-stigs-virtualization-uri">https://www.cyber.mil/stigs/downloads/?_dl_facet_stigs=operating-systems%2Cvirtualization</xsl:variable>
...
<xsl:variable name="nerc-cipuri">https://www.nerc.com/standards/reliability-standards/cip</xsl:variable>
