...
def expand_xccdf_subs(fix, remediation_type, remediation_functions):
    ...
    if remediation_type == "puppet":
        ...
        if 'INCLUDE_SHARED_REMEDIATION_FUNCTIONS' not in fix.text:
            return
        ...
        if fixparts[0] is not None:
            ...
            try:
                rfpattern = '(INCLUDE_SHARED_REMEDIATION_FUNCTIONS)(.*)'
        ...
        for f in remediation_functions:
            # Then define expected XCCDF sub element form for this function
