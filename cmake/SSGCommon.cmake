...
macro(ssg_build_xccdf_unlinked PRODUCT)
    add_custom_command(
        ...
        COMMAND "${SSG_SHARED_UTILS}/filter-environment-restriction.py" --input "${CMAKE_CURRENT_BINARY_DIR}/shorthand.xml" --output "${CMAKE_CURRENT_BINARY_DIR}/filtered_shorthand.xml"
