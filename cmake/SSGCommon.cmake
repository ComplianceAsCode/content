...
macro(ssg_build_oval_unlinked PRODUCT)
    ...
    if(OSCAP_OVAL_511_SUPPORT EQUAL 0)
        ...
        add_custom_command(
            ...
            # TODO: config
            COMMAND RUNTIME_OVAL_VERSION=5.11 "${SSG_SHARED_UTILS}/combine-ovals.py" "${CMAKE_SOURCE_DIR}/config" "${PRODUCT}" ${OVAL_510_COMBINE_PATHS} ${OVAL_511_COMBINE_PATHS} > "${CMAKE_CURRENT_BINARY_DIR}/oval-unlinked.xml"
