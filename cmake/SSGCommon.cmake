...
macro(ssg_build_ansible_roles)
    set(ANSIBLE_ROLES_DIR "${CMAKE_CURRENT_BINARY_DIR}/ansible/roles")
    add_custom_command(
        OUTPUT "${ANSIBLE_ROLES_DIR}/ansible_roles-${PRODUCT}"
        COMMAND env "PYTHONPATH=$ENV{PYTHONPATH}" "${Python_EXECUTABLE}" "${CMAKE_SOURCE_DIR}/utils/ansible_playbook_to_role.py" --dry-run "${CMAKE_BINARY_DIR}/roles" --product "${PRODUCT}" --build-playbooks-dir "${CMAKE_BINARY_DIR}/ansible"
        # COMMAND echo "sajkldasjdl" > ${CMAKE_BINARY_DIR}/teste
        DEPENDS generate-all-profile-playbooks-${PRODUCT}
        COMMENT "[ansible-roles-generation] Generating Ansible Roles"
    )
    add_custom_target(
...
macro(ssg_build_product PRODUCT)
    ...
    set(SSG_THIN_DS_COMPONENTS_DIR "off")
