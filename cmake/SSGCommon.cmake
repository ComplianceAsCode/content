...
macro(ssg_build_remediations PRODUCT)
    ...
    add_custom_command(
        ...
        COMMAND SHARED=${SSG_SHARED} ${SSG_SHARED_UTILS}/combine-remediations.py ${PRODUCT} puppet ${SSG_SHARED}/templates/output/puppet ${CMAKE_CURRENT_SOURCE_DIR}/templates/output/puppet ${CMAKE_CURRENT_BINARY_DIR}/puppet-remediations.xml
