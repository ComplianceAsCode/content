...
# This file assumes that we have two routes outside the openshift/kube namespaces, and 
# one route has rate limit enabled, and one route does not
    ...
    "items": [
        ...
        },
        {
            ...
            "metadata": {
                ...
                "name": "wordpress-with-ip-whitlist",
                "namespace": "test-no-rate-limit",
                "resourceVersion": "214119",
                "uid": "26f97c95-7351-49b8-a0dd-f6cdd88283ae"
            },
