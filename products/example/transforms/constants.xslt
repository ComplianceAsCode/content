...
<xsl:variable name="product_long_name">Example</xsl:variable>
<xsl:variable name="product_short_name">Example</xsl:variable>
<xsl:variable name="product_stig_id_name">empty</xsl:variable>
<xsl:variable name="prod_type">example</xsl:variable>
