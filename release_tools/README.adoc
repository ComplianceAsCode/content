...
The script also builds RHEL7 content to check for missing STIG IDs in STIG profiles. +
**Review the status** of missing STIG IDs `rhel7-stig-ids.log` files, fix if necessary. +
