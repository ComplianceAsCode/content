...
def main():
    ...
    relative_guide_dirs = ssg.utils.required_key(env_yaml, "benchmark_root")
    ...
    rule_id_to_remediation_map = collect_fixes(
        product, guide_dirs, args.fix_dirs, args.remediation_type)
...
def collect_fixes(product, guide_dirs, fix_dirs, remediation_type):
    # path -> remediation
    # rule ID -> assoc rule
    ...
    for _dir_path in ssg.rules.find_rule_dirs_list(guide_dirs):
