...
def collect_sce_checks(datastreamtree, checklists):
...
def compose_ds(
    ...
    if sce_enabled:
        sce_checks = collect_sce_checks(ds_collection, checklists)
        refdir = os.path.dirname(oval_file_name)
        embed_sce_checks_in_datastream(ds_collection, checklists, sce_checks, refdir)
