...
<xsl:variable name="product_short_name">RHEL OSP 10</xsl:variable>
<xsl:variable name="product_stig_id_name">RHEL_OSP_10_STIG</xsl:variable>
<xsl:variable name="prod_type">osp10</xsl:variable>
