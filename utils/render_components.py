...
def create_component_html(output_dir, component_data):
...
def find_rule_paths(component_rules, resolved_rules_dir):
    rule_paths = []
...
def process_component(component_path, resolved_rules_dir, output_product_dir):
...
def process_components(components_dir, resolved_rules_dir, output_product_dir):
    component_names = []
...
def process_product(product_id, ssg_root, output_dir):
...
def process_products(ssg_root, output_dir):
