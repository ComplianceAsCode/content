...
#   the src/input/checks directory
#
...
##
#
# The directory src/input/checks contains all of the OVAL checks that are
...
# src/input/checks directory. The ID of this check *must* be
...
#     <metadata>
#
# This piece of Python will step through each OVAL check in src/input/checks
...
# corresponding OVAL check exists in the src/input/checks directory. We print
