...
# template contains the following tags that *must* be replaced successfully in order for the fixes to work.
#
...
def output_checkfile(serviceinfo):
    ...
    with open("./template_service_disabled", 'r') as templatefile:
        ...
        with open("./output/service_" + servicename + "_disabled.sh", 'wb+') as outputfile:
