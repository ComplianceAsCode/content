...
common_parser.add_argument("--loglevel", dest = "loglevel",
    metavar = "LOGLEVEL",
    default = "WARNING",
    help = "Default level of console output"
)
common_parser.add_argument("--logdir", dest = "logdir",
    metavar = "LOGDIR",
    default = None,
...
parser_profile = subparsers.add_parser('profile',
                        help=('Testing profile-based remediation '
                              'applied on already installed machine'),
...
parser_rule = subparsers.add_parser('rule',
                        help=('Testing remediations of particular '
                              'rule for various situations - currently '
                              'not supported by openscap!'),
                        parents=[common_parser])
