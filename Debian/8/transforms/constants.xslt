...
<xsl:variable name="product_long_name">Debian 8</xsl:variable>
...
<xsl:variable name="platform_cpes">cpe:/o:debianproject:debian:8</xsl:variable>
<xsl:variable name="os_type">debian</xsl:variable>
