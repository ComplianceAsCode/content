...
add_dconf_setting "org/gnome/desktop/screensaver" "lock-delay" "uint32 100" "{{{ dconf_gdm_dir }}}" "00-security-settings"
{{% else %}}
add_dconf_setting "org/gnome/desktop/screensaver" "lock-delay" "uint32 100" "local.d" "00-security-settings"
{{% endif %}}
