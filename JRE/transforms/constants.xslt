...
<xsl:variable name="product_long_name">Java Runtime Environment</xsl:variable>
<xsl:variable name="product_short_name">JRE</xsl:variable>
<xsl:variable name="product_stig_id_name">JRE_STIG</xsl:variable>
<xsl:variable name="os_type">jre</xsl:variable>
