...
`PyYAML`, `python-jinja2`, `python-setuptools`, `pyparsing` and their dependencies are installed:

```bash
yum install cmake make openscap-utils openscap-scanner pyparsing PyYAML python-jinja2
```
...
```bash
yum install cmake make openscap-utils openscap-scanner python3-pyyaml python3-jinja2 python3-setuptools python3-pyparsing
```

On *Ubuntu* and *Debian*, make sure the packages `libopenscap8`,
`libxml2-utils`, `python3-jinja2`, `python3-yaml`, `python3-setuptools`, `python3-pyparsing`, `xsltproc` and their dependencies are
installed:

```bash
apt-get install cmake make expat libopenscap8 libxml2-utils ninja-build python3-jinja2 python3-yaml python3-setuptools python3-pyparsing xsltproc
```
