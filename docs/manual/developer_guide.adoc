...
audit_rules_rule_file::
* Ensure that certain file with Audit rules provided in /usr/share/audit/sample-rules is placed in /etc/audit/rules.d/
* Parameters:
** *file_id* - a part of the file name without the .rules extension, e.g. `10-base-config`
* Languages: Ansible, Bash, OVAL
