...
government or commercial compliance standards. For an example profile, see
link:https://github.com/OpenSCAP/scap-security-guide/blob/master/docs/example.profile[docs/example.profile]
