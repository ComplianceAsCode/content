...
To successfully build ComplianceAsCode, the following packages must be installed:

* ``make``
* ``cmake``
* ``python36`` (RHEL8)
* ``python3-pyyaml`` (RHEL8)
* ``python3-jinja2`` (RHEL8)

`````
$ sudo yum -y install cmake make python36 python3-pyyaml python3-jinja2
`````
