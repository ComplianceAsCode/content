...
|`linux_os`
| Contains security content for Linux operating systems. Contains rules, OVAL checks, Ansible tasks, Bash remeditions, ..

|`applications`
| Contains security content for applications such as OpenShift or OpenStack.
...
The most important benchmark is *Linux OS*.
This benchmark describes Linux Operating System in general.
Therefore this benchmark is used by multiple ComplianceAsCode products, eg. `rhel7`, `fedora`, `ubuntu1404`, `sle11` etc.
