...
== Supplementary Links
=== NIST SCAP Community
The following mailing lists may be of interest to individuals seeking an understanding of SCAP specifications, or those looking for questions/answers about developing SCAP content.

| Mailing List | Purpose |
|:-------------|:--------|
|link:https://list.nist.gov/scap-dev-content[https://list.nist.gov/scap-dev-content]|For discussion and development around content metadata.|
|link:https://list.nist.gov/scap-dev-applicability[https://list.nist.gov/scap-dev-applicability]|For work on an SCAP v2 applicability language.|
|link:https://list.nist.gov/scap-dev-oval[https://list.nist.gov/scap-dev-oval]|For work on checking languages and iteration of OVAL.|
|link:https://list.nist.gov/scap-dev-endpoint[https://list.nist.gov/scap-dev-endpoint]|Discussion involving endpoint data collection.|
|link:https://list.nist.gov/scap-dev-authoring[https://list.nist.gov/scap-dev-authoring]|For discussion and development of XCCDF and related work.|
