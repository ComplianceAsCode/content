...
** *type* (string/SimpleDatatypeEnumeration) - datatype for state's value_of, optional.
** *check* (string/CheckEnumeration) - entity_check value for state's value_of, optional.
** *negate* (boolean) - invert the meaning of the value check criterion, optional (default: false).
** *ocp_data* (boolean) - the file is the part of the dump of OCP configuration, take into account the 'ocp_data_root', optional (default: false).
* Languages: OVAL
