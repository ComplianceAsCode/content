...
* Other parameters are also used for supporting running tests in this kind of environment. For example, you use `--add-platform "cpe:/o:fedoraproject:fedora:34"` to make the RHEL8 content applicable to Fedora images.
====
